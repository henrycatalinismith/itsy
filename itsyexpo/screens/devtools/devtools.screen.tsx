...
export interface DevtoolsScreenProps {
  navigation: StackNavigationProp<RootStackParamList, "Devtools">
  route: RouteProp<RootStackParamList, "Devtools">
}
...
export function DevtoolsScreen({ navigation, route }: DevtoolsScreenProps) {
...
export default connect(mapStateToProps, mapDispatchToProps)(DevtoolsScreen)
